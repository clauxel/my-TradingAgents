export function MulticaLaunchLogo() {
  return (
    <svg viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <defs>
        <linearGradient id="tradingagents-border" x1="10" y1="10" x2="54" y2="54" gradientUnits="userSpaceOnUse">
          <stop stopColor="#7cff88" stopOpacity="0.9" />
          <stop offset="1" stopColor="#52d8ff" stopOpacity="0.72" />
        </linearGradient>
        <radialGradient
          id="tradingagents-bg"
          cx="0" cy="0" r="1"
        ...
        >
          <stop offset="0" stopColor="#11201a" />
          <stop offset="0.58" stopColor="#0a1614" />
          <stop offset="1" stopColor="#07100e" />
        </radialGradient>
      </defs>
      <rect x="4" y="4" width="56" height="56" rx="14" fill="url(#tradingagents-bg)" />
      <rect x="4.75" y="4.75" width="54.5" height="54.5" rx="13.25" stroke="url(#tradingagents-border)" strokeWidth="1.5" />
      <path d="M18 18v28" stroke="#7cff88" strokeWidth="2.6" strokeLinecap="round" />
      <rect x="14.5" y="22" width="7" height="12" rx="2.5" fill="#7cff88" />
      <path d="M32 14v34" stroke="#eef8f4" strokeWidth="2.6" strokeLinecap="round" />
      <rect x="28.5" y="18" width="7" height="18" rx="2.5" fill="#eef8f4" />
      <path d="M46 20v24" stroke="#52d8ff" strokeWidth="2.6" strokeLinecap="round" />
      <rect x="42.5" y="28" width="7" height="10" rx="2.5" fill="#52d8ff" />
      <path d="M17 45c6-4 11-8 15-13 4-4 8-8 16-12" stroke="url(#tradingagents-border)" strokeWidth="2.4" strokeLinecap="round" />
    </svg>
  )
}
